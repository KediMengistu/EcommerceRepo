...
public class Payment {
    ...
    public Payment(int paymentid, int paiditemid, String paiditemname, String paiditemdescription, int sellerid, int payerid, String paymentstyle, double submittedbid, double shippingprice, double expeditedcost, double defaulttotal) {
